...
| 主題 | 想了解 | 文件 | 路徑 |
|------|---------|------|------|
| 資料 | 欄位定義 | data_資料欄位定義.md | docs/model/ |
| 資料 | 資料處理規則 | data_資料處理規則.md | docs/model/ |
| 資料 | Pipeline 流程 | data_資料處理流程.md | docs/model/ |
| 機器學習 | 特徵配置 | ml_特徵配置.yaml | docs/model/ |
| Pipeline | 如何修改 | pipeline_修改指南.md | docs/shared/ |
...
| 開發任務 | 文件 | 路徑 |
|----------|------|------|
| 規劃優化方向 | optimization_roadmap.md | docs/model/ |
| 實驗紀錄 | WORK_LOG_票房預測模型優化流程.md | docs/work_log/ |
| 追蹤進度 | WORK_LOG_模型優化進度.md | docs/work_log/ |
| 紀錄評估結果 | WORK_LOG_模型評估與模型產出_20251119.md | docs/work_log/ |
