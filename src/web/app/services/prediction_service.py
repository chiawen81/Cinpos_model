...
# 加入 ML 路徑以便匯入預測模組
# Path: services/prediction_service.py -> services/ -> app/ -> web/ -> src/
src_root = Path(__file__).parent.parent.parent.parent
ml_path = src_root / "ml" / "boxoffice" / "phase5_apply"
...
from .decline_warning_service import get_decline_warning_service
